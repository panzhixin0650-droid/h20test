#!/usr/bin/env bash
# Single-node H20 benchmark: true GQLA cache + HPC-Ops decode, TP8/PP1,
# exact 16K input and 128-token output. The shared H20 launcher enables
# strict route checks and selects an unused -attemptN result directory.
...
export OUTPUT_ROOT=${OUTPUT_ROOT:-$GQLA_ROOT/outputs/benchmarks/dsv3p1_g8_gqla_h20_tp8_16k}
export RUN_ID=${RUN_ID:-h20-gqla-tp8-16k-001}
